 ...
 *
 */
public class MyReportActivity extends BaseActivity implements RefreshListServerListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				if(id>=0){
					...
					bundle.putString(MyReportDetailActivity.RECORDNO, data.get(MyReportDetailActivity.RECORDNO));
					Intent intent=new Intent(getAppContext(),MyReportDetailActivity.class);
		...
		mRefreshListServer = new RefreshListServer(this, mListView,new MyReportAdapter(this));
