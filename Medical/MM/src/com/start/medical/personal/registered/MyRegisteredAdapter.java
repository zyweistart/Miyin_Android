...
public class MyRegisteredAdapter extends AppListAdapter{

	public MyRegisteredAdapter(BaseActivity activity) {
		super(activity);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		HolderView holder;
		if (convertView == null) {
			convertView = mActivity.getLayoutInflater().inflate(R.layout.listitem_myregistered, null);
