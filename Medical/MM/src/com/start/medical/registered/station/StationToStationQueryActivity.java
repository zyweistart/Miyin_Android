...
public class StationToStationQueryActivity extends BaseActivity implements RefreshListServerListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mRefreshListServer = new RefreshListServer(this, mListView,new StationToStationQueryAdapter(this));
	...
	public void onLoading(final int HANDLER) {
		HttpServer hServer = new HttpServer(Constant.URL.hisregQuery,mRefreshListServer.getHandlerContext());
