...
public class MyReportAdapter extends AppListAdapter{

	public MyReportAdapter(BaseActivity activity) {
		super(activity);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		HolderView holder;
		if (convertView == null) {
			convertView = mActivity.getLayoutInflater().inflate(R.layout.listitem_myreport, null);
