 ...
 *
 */
public class MyRegisteredActivity extends BaseActivity implements RefreshListServerListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				if(id>=0){
					...
					bundle.putString(MyRegisteredDetailActivity.RECORDNO, data.get(MyRegisteredDetailActivity.RECORDNO));
					Intent intent=new Intent(getAppContext(),MyRegisteredDetailActivity.class);
		...
		mRefreshListServer = new RefreshListServer(this, mListView,new MyRegisteredAdapter(this));
