		...
		try {
			...
			mMediaPlayer.setOnCompletionListener(new OnCompletionListener() {
				...
				public void onCompletion(MediaPlayer mp) {
					currentPosition=0;
					player_view_ib_player.setImageDrawable(getContext().getResources().getDrawable(R.drawable.play));
			...
			player_view_ib_player.setImageDrawable(getContext().getResources().getDrawable(R.drawable.pause));
			player_view_tv_playtime.setText(TimeUtils.convertTime(currentPosition));
